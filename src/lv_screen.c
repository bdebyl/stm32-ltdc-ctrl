...
void lv_ex_btn_1(void) {
    ...
    lv_meter_set_scale_major_ticks(meter, scale, 8, 4, 15, lv_color_black(),
                                   10);
    lv_meter_set_scale_range(meter, scale, 0, 8500, 300, 120);
    ...
    lv_meter_set_indicator_start_value(meter, indic, 6500);
    lv_meter_set_indicator_end_value(meter, indic, 8500);
    ...
    lv_meter_set_indicator_value(meter, indic, 6700);

    lv_obj_t* label = lv_label_create(meter);
    lv_label_set_text(label, "KW/H");
